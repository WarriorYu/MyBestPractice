...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private static final String TAG = "GFCrashHandler";
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            Log.e(TAG, "an error occured when collect package userIndex", e);
        }
        ...
        for (Field field : fields) {
            try {
                ...
                Log.e(TAG, "an error occured when collect crash userIndex", e);
            }
        }
    }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = Environment.getExternalStorageDirectory() + "/gf_crash/";
